...
for i in zz:
    ...
    #word_fre.to_excel(r"G:\8泰迪\python_project\51_job\词云图\{}.xlsx".format(i), encoding="gbk", index=None)
...
word.to_excel(r"G:\8泰迪\python_project\51_job\词云图.xlsx",encoding="gbk",index=None)



x  = pd.read_csv(r"G:\8泰迪\python_project\51_job\词云图\bb.csv", encoding='GBK',engine="python")
x["热词"] = x["热词"].apply(lambda x:x[2:-1])
x.to_excel(r"G:\8泰迪\python_project\51_job\词云图\bb.xlsx", encoding="gbk", index=None)
